...
\usepackage{titling}
\title{Semantic Segmentation of Curbs and Curb Cuts from Street Imagery}
...
\newcommand{\advisers}{Jannik Zürn, M. Sc.}
...
%    \pagestyle{plain} % remove chapter name from top, page number at the bottom
    ...
    \input{chapters/0_3-acknowledgments}
    \tableofcontents
    \listoffigures
    \listoftables
